...
{% include image.html lightbox="true" file="https://files.readme.io/d7982ed-codefresh_add_repo.png" url="https://files.readme.io/d7982ed-codefresh_add_repo.png" alt="Add repository" max-width="40%" %}
  
{:start="2"}
2. Select the relevant repository. In this case select the **`<your-repo-name>/demochat`**
  {% include image.html lightbox="true" file="https://files.readme.io/94b6a4d-codefresh_demochat_select.png" url="https://files.readme.io/94b6a4d-codefresh_demochat_select.png" alt="Select the relevant repository" max-width="40%" %}
...
4. Click **Next** 
  ...
  {% include image.html lightbox="true" file="https://files.readme.io/1a40b27-codefresh_demochat_build_method.png" url="https://files.readme.io/1a40b27-codefresh_demochat_build_method.png" alt="Select build method" max-width="40%" %}
...
6. By default, Codefresh searches for your Dockerfile at the root level of your repository, by the name Dockerfile. The demo-chat example includes a Dockerfile in the root level.
  {% include image.html lightbox="true" file="https://files.readme.io/d81622a-cf_demochat_dockerfile.png" url="https://files.readme.io/d81622a-cf_demochat_dockerfile.png" alt="" max-width="40%" %}
...
{% include image.html lightbox="true" file="https://files.readme.io/30f0a3a-cf_demochat_review.png" url="https://files.readme.io/30f0a3a-cf_demochat_review.png" alt="" max-width="40%" %}

Congratulations, the new service is added!
{% include image.html lightbox="true" file="https://files.readme.io/4c1b6db-cf_demochat_done.png" url="https://files.readme.io/4c1b6db-cf_demochat_done.png" alt="" max-width="40%" %}
...
{% include image.html lightbox="true" file="https://files.readme.io/0fa8d30-cf_demochat_done.png" url="https://files.readme.io/0fa8d30-cf_demochat_done.png" alt="" max-width="40%" %}

  The **Builds** screen of the newly created service is displayed showing the build progress.
{% include image.html lightbox="true" file="https://files.readme.io/31e9222-cf_demochat_build.png" url="https://files.readme.io/31e9222-cf_demochat_build.png" alt="" max-width="40%" %}
...
{% include image.html lightbox="true" file="https://files.readme.io/5613e4c-codefresh_images_repo.png" url="https://files.readme.io/5613e4c-codefresh_images_repo.png" alt="" max-width="40%" %}

The **Images** screen is displayed with details of the newly created image.
{% include image.html lightbox="true" file="https://files.readme.io/26353f1-codefresh_image_demochat.png" url="https://files.readme.io/26353f1-codefresh_image_demochat.png" alt="" max-width="40%" %}
...
{% include image.html lightbox="true" file="https://files.readme.io/15bf4d8-Services_screen.JPG" url="https://files.readme.io/15bf4d8-Services_screen.JPG" alt="" max-width="40%" %}

{:start="3"} 
3. In the **Workflow** section (at the middle of the **Pipelines** screen), in the **Unit Test Script** command line box, type `npm test`.
{% include image.html lightbox="true" file="https://files.readme.io/9832cfd-npmtest.JPG" url="https://files.readme.io/9832cfd-npmtest.JPG" alt="" max-width="40%" %}
...
{% include image.html lightbox="true" file="https://files.readme.io/a8e599a-Screen_Shot_2017-10-23_at_7.17.58_PM.png" url="https://files.readme.io/a8e599a-Screen_Shot_2017-10-23_at_7.17.58_PM.png" alt="" max-width="40%" %} 
...
{% include image.html lightbox="true" file="https://files.readme.io/5bb09fb-Screen_Shot_2017-10-23_at_7.13.26_PM.png" url="https://files.readme.io/5bb09fb-Screen_Shot_2017-10-23_at_7.13.26_PM.png" alt="" max-width="40%" %}
...
{% include image.html lightbox="true" file="https://files.readme.io/341ed85-accountmanagement.PNG" url="https://files.readme.io/341ed85-accountmanagement.PNG" alt="" max-width="40%" %}  
...
{% include image.html lightbox="true" file="https://files.readme.io/38e2b04-integrations-page.png" url="https://files.readme.io/38e2b04-integrations-page.png" alt="" max-width="40%" %}
...
{:start="2"}
2. Click the **Pipelines** icon of the “demochat” service.
{% include image.html lightbox="true" file="https://files.readme.io/3463993-Services_screen.JPG" url="https://files.readme.io/3463993-Services_screen.JPG" alt="" max-width="40%" %} 

{:start="3"}
3. In the Workflow section under the **Push to Registry** section, select your registry configuration
{% include image.html lightbox="true" file="https://files.readme.io/719c804-screenshot-g.codefresh.io-2017-11-21-14-59-59.png" url="https://files.readme.io/719c804-screenshot-g.codefresh.io-2017-11-21-14-59-59.png" alt="" max-width="40%" %}
...
{% include image.html lightbox="true" file="https://files.readme.io/f18d734-Capture10.PNG" url="https://files.readme.io/f18d734-Capture10.PNG" alt="" max-width="40%" %} 

{:start="6"}
6. Add a description for the change and click **Commit Changes**.
{% include image.html lightbox="true" file="https://files.readme.io/e892f64-myfirstcommit.PNG" url="https://files.readme.io/e892f64-myfirstcommit.PNG" alt="" max-width="40%" %} 

The new Commit invokes the Codefresh pipeline, generating a new Docker image.
{% include image.html lightbox="true" file="https://files.readme.io/af69126-Capture3.PNG" url="https://files.readme.io/af69126-Capture3.PNG" alt="" max-width="40%" %} 

The process success is also indicated in Github:
{% include image.html lightbox="true" file="https://files.readme.io/25398b5-Capture4.PNG" url="https://files.readme.io/25398b5-Capture4.PNG" alt="" max-width="40%" %}
...
{% include image.html lightbox="true" file="https://files.readme.io/45e070b-Capture6.PNG" url="https://files.readme.io/45e070b-Capture6.PNG" alt="" max-width="40%" %} 

{:start="8"} 
8. The pull request is displayed in Codefresh under the **Services > <your-repo-name> > demochat **under the **Pipelines** tab:
{% include image.html lightbox="true" file="https://files.readme.io/9b6f1da-Capture10.PNG" url="https://files.readme.io/9b6f1da-Capture10.PNG" alt="" max-width="40%" %}
...
{% include image.html lightbox="true" file="https://files.readme.io/d0eb485-Capture11.PNG" url="https://files.readme.io/d0eb485-Capture11.PNG" alt="" max-width="40%" %} 
...
10. Click **Confirm Merge**. 
  ...
  {% include image.html lightbox="true" file="https://files.readme.io/b2ac192-Capture15.PNG" url="https://files.readme.io/b2ac192-Capture15.PNG" alt="" max-width="40%" %}
  ...
  {% include image.html lightbox="true" file="https://files.readme.io/2162d7a-Capture16.PNG" url="https://files.readme.io/2162d7a-Capture16.PNG" alt="" max-width="40%" %}
