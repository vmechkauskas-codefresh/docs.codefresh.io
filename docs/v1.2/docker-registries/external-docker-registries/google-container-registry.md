...
{% include image.html lightbox="true" file="/uploads/images/docs/220c472-add-gcr-new.png" url="/uploads/images/docs/220c472-add-gcr-new.png" alt="Add Google Container Registry" max-width="45%" %}
