...
* [**From file in repo**]({{ site.baseurl }}/docs/{{ site.docs_version }}/on-demand-test-environment/composition-dialog/#31-from-file-in-repo) 
* [**From template**]({{ site.baseurl }}/docs/{{ site.docs_version }}/on-demand-test-environment/composition-dialog/#32-from-template)
* [**Empty composition**]({{ site.baseurl }}/docs/{{ site.docs_version }}/on-demand-test-environment/composition-dialog/#33-empty-composition)
